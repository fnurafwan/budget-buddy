        ...
        {expenses.length > 0 && (
          <div className="relative flex-1 min-w-[180px] max-w-xs">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1 rounded-xl border-2 border-foreground/10 bg-input text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
            />
            {historySearch && (
