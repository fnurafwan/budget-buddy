        ...
        <div className="flex flex-wrap items-center gap-2 mb-5 mt-6">
          ...
          <div className="relative flex-1 min-w-[160px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 text-sm rounded-xl border-2 border-foreground/10 bg-input text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
            />
            {search && (
              <button
                onClick={() => setSearch('')}
