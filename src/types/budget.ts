export type Category = 'food' | 'travel' | 'savings' | 'entertainment' | 'utilities' | 'shopping' | 'health' | 'education' | 'thr' | 'dailyExpense';
...
export const CATEGORIES: { value: Category; label: string; icon: string; color: string }[] = [
  { value: 'dailyExpense', label: 'Daily Expense', icon: 'ShoppingCart', color: 'text-expense' },
